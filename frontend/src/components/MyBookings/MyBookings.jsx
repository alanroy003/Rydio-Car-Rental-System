        ...
        <div className={s.modalContent}>
          <div className={s.modalHeader}>
            <h2 className={s.modalTitle}>
              <FaReceipt className="text-blue-400" /> Booking Details
            </h2>
          ...
          <div className={s.modalGrid}>
            <div className="space-y-4">
              <h3 className="text-lg font-semibold flex items-center gap-2">
                <FaCalendarAlt className="text-blue-400" /> Booking Dates
              </h3>
              ...
              <h3 className="text-lg font-semibold flex items-center gap-2 mt-6">
                <FaMapMarkerAlt className="text-blue-400" /> Location Details
              </h3>
              <div className={s.infoCard}>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold flex items-center gap-2 mt-6">
                <FaUser className="text-blue-400" /> User Information
              </h3>
              <div className={s.infoCard}>
                <div className="mb-3">
              ...
              <h3 className="text-lg font-semibold flex items-center gap-2 mt-6">
                <FaCreditCard className="text-blue-400" /> Payment Details
              </h3>
              <div className={s.infoCard}>
                <div className="mb-3">
