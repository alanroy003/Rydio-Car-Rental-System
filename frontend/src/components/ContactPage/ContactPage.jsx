...
const ContactPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(`https://wa.me/+971568018730?text=${whatsappMessage}`, '_blank');
    ...
    <div className={styles.container}>
      ...
      <div className={styles.diamondPattern}>
        <div className="w-full h-full" style={{
          backgroundImage: `
            linear-gradient(30deg, rgba(59,130,246,0.08) 12%, transparent 12.5%, transparent 87%, rgba(59,130,246,0.08) 87.5%, rgba(59,130,246,0.08)),
            linear-gradient(150deg, rgba(59,130,246,0.08) 12%, transparent 12.5%, transparent 87%, rgba(59,130,246,0.08) 87.5%, rgba(59,130,246,0.08)),
            linear-gradient(30deg, rgba(59,130,246,0.08) 12%, transparent 12.5%, transparent 87%, rgba(59,130,246,0.08) 87.5%, rgba(59,130,246,0.08)),
            linear-gradient(150deg, rgba(59,130,246,0.08) 12%, transparent 12.5%, transparent 87%, rgba(59,130,246,0.08) 87.5%, rgba(59,130,246,0.08)),
            linear-gradient(60deg, rgba(37,99,235,0.08) 25%, transparent 25.5%, transparent 75%, rgba(37,99,235,0.08) 75%, rgba(37,99,235,0.08)),
            linear-gradient(60deg, rgba(37,99,235,0.08) 25%, transparent 25.5%, transparent 75%, rgba(37,99,235,0.08) 75%, rgba(37,99,235,0.08))`,
        ...
        {[...Array(15)].map((_, i) => (
          <div
            ...
            style={{
              ...
              background: i % 3 === 0 ? '#3b82f6' : i % 3 === 1 ? '#60a5fa' : '#93c5fd',
          ...
          <div className={styles.infoCard}>
            ...
            <div className="relative z-10 space-y-5">
              ...
              <div className={styles.infoItemContainer}>
                {[
                  { icon: FaWhatsapp, label: 'WhatsApp', value: '+971568018730', color: 'bg-green-900/30' },
                  { icon: FaEnvelope, label: 'Email', value: 'alanroy3002@gmail.com', color: 'bg-blue-900/30' },
                ].map((info, i) => (
                  <div
                    key={i}
                  ...
                  >
                    <div className={styles.iconContainer(info.color)}>
                      <info.icon className={i === 0 ? 'text-green-400 text-lg' : 'text-blue-400 text-lg'} />
                    </div>
                    <div>
