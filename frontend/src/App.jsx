    ...
    <>
      ...
      {showButton && (
        <button
          ...
          className="fixed cursor-pointer bottom-8 right-8 p-3 rounded-full bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg transition-colors focus:outline-none"
        >
