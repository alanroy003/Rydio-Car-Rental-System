...
export const navbarStyles = {
  ...
  navLink: {
    ...
    active: "text-blue-600 underline underline-offset-4",
    inactive: "text-gray-700 hover:text-blue-500"
  },
  separator: "hidden md:block h-6 w-px bg-gray-300 mx-2",
  userActions: "hidden md:flex md:items-center md:justify-end md:gap-4",
  authButton: "flex items-center gap-2 cursor-pointer text-gray-700 hover:text-blue-500 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-300 rounded-md px-3 py-2",
  authText: "text-sm font-medium",
  mobileMenuButton: "p-2 rounded-md text-gray-700 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-300",
  mobileMenu: {
  ...
  mobileLink: {
    ...
    active: "bg-gray-50 text-blue-600",
...
export const loginStyles = {
  ...
  animatedBackground: {
    ...
    orb1: "absolute top-1/4 left-1/5 rounded-full blur-3xl transition-all duration-1000 w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 bg-gradient-to-r from-blue-400/10 to-blue-600/10",
    orb2: "absolute top-3/4 right-1/4 rounded-full blur-3xl transition-all duration-1000 w-40 h-40 sm:w-44 sm:h-44 md:w-48 md:h-48 bg-gradient-to-r from-blue-300/10 to-blue-500/10",
    orb3: "absolute bottom-1/3 left-2/3 rounded-full blur-3xl transition-all duration-1000 w-28 h-28 sm:w-32 sm:h-32 bg-gradient-to-r from-blue-200/10 to-blue-400/10"
  },
  ...
  loginCard: {
    ...
    decor1: "absolute -top-8 -right-8 w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-gradient-to-r from-blue-400/10 to-blue-500/10 blur-2xl z-0",
    decor2: "absolute -bottom-6 -left-6 w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-r from-blue-300/10 to-blue-400/10 blur-2xl z-0",
    ...
    title: "text-2xl sm:text-3xl font-bold tracking-tight bg-gradient-to-r from-blue-300 to-white bg-clip-text text-transparent",
    subtitle: "mt-1 sm:mt-2 font-light tracking-wider text-xs sm:text-sm text-blue-300/60"
  },
  ...
  form: {
    ...
    inputIcon: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-blue-300/80",
    input: "w-full pl-10 pr-3 py-3 sm:py-4 rounded-xl text-sm sm:text-base placeholder-opacity-70 border transition duration-300 focus:outline-none focus:ring-2 focus:border-transparent bg-white/5 backdrop-blur-sm text-white/90 placeholder-blue-200/40 border-white/10 focus:ring-blue-500/70",
    passwordToggle: "absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer transition-colors text-blue-300/80 hover:text-blue-200/90",
    submitButton: "w-full py-3 sm:py-4 rounded-full font-bold shadow-lg hover:shadow-xl transition-transform duration-300 transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 relative overflow-hidden group bg-gradient-to-r from-blue-500/90 to-blue-600/90 text-white/95 hover:from-blue-600/90 hover:to-blue-700/90 focus:ring-blue-500/70",
    buttonText: "relative cursor-pointer z-10 text-sm sm:text-base",
    buttonHover: "absolute inset-0 transition-opacity duration-300 z-0 opacity-0 group-hover:opacity-100 bg-gradient-to-r from-blue-400/50 to-blue-500/50"
  },

  signupSection: "mt-6 pt-6 border-t border-white/10 text-center text-xs sm:text-sm",
  signupText: "text-blue-200/70",
  signupButton: "inline-block mt-2 w-full cursor-pointer px-4 py-2 rounded-xl font-medium transition-transform duration-300 transform hover:-translate-y-0.5 bg-transparent border border-blue-500/50 text-blue-300/90 hover:bg-blue-500/10 hover:text-white/90"
};
...
export const signupStyles = {
  ...
  animatedBackground: {
    base: "absolute inset-0 z-0 overflow-hidden",
    orb1: "absolute top-[10%] sm:top-1/4 left-[5%] sm:left-1/5 w-40 h-40 sm:w-52 sm:h-52 md:w-64 md:h-64 rounded-full transition-all duration-1000 bg-gradient-to-r from-blue-200/10 to-blue-400/10 blur-3xl",
    orb2: "absolute top-[75%] sm:top-3/4 right-[5%] sm:right-1/4 w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full transition-all duration-1000 bg-gradient-to-r from-blue-200/8 to-blue-300/8 blur-3xl",
    orb3: "absolute bottom-[15%] sm:bottom-1/3 left-[65%] sm:left-2/3 w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full transition-all duration-1000 bg-gradient-to-r from-blue-100/8 to-blue-300/10 blur-3xl"
  },
  ...
  signupCard: {
    ...
    decor1: "absolute -top-6 sm:-top-8 -right-6 sm:-right-8 w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full bg-gradient-to-r from-blue-300/10 to-blue-400/10 blur-2xl z-0",
    decor2: "absolute -bottom-4 sm:-bottom-6 -left-4 sm:-left-6 w-20 h-20 sm:w-22 sm:h-22 md:w-24 md:h-24 rounded-full bg-gradient-to-r from-blue-200/8 to-blue-300/10 blur-2xl z-0",
    headerContainer: "relative z-10 text-center mb-6 sm:mb-8",
    logoContainer: "mx-auto mb-4 w-24 h-24 sm:w-28 sm:h-28 rounded-full flex items-center justify-center",
    logoText: "flex flex-col items-center text-xl md:text-2xl lg:text-2xl leading-none",
    title: "text-2xl sm:text-3xl md:text-4xl font-bold mt-2 sm:mt-3 md:mt-4 tracking-tight bg-gradient-to-r from-blue-300 to-white bg-clip-text text-transparent",
    subtitle: "mt-1 sm:mt-2 text-xs sm:text-sm md:text-base font-light tracking-wider text-blue-300/60"
  },
  ...
  form: {
    ...
    inputWrapper: "relative",
    inputIcon: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-blue-300/80",
    input: "w-full pl-10 pr-3 py-2 sm:py-3 md:py-4 rounded-xl text-xs sm:text-sm placeholder-opacity-70 border focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 bg-white/5 backdrop-blur-sm text-white/90 placeholder-blue-200/40 border-white/10 focus:ring-blue-500/70",
    passwordToggle: "absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer transition-colors text-blue-300/80 hover:text-blue-200/90",
    checkbox: "h-4 w-4 sm:h-5 sm:w-5 rounded focus:ring-0 border text-blue-600 border-gray-500 bg-gray-700/30 checked:bg-blue-500/80",
    checkboxLabel: "ml-2 sm:ml-3 text-xs sm:text-sm text-blue-200/80 cursor-pointer select-none",
    checkboxLink: "font-medium text-blue-300 hover:underline",
    ...
    buttonHover: "absolute inset-0 py-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-0 bg-gradient-to-r from-blue-400/50 to-blue-500/50"
  },

  signinSection: "mt-2 pt-2 sm:pt-3 border-t text-center",
  signinText: "mb-2 sm:mb-3 md:mb-4 text-xs sm:text-sm md:text-base text-blue-200/70",
  signinButton: "inline-block w-full px-3 py-2 sm:px-4 sm:py-2 md:px-6 md:py-3 rounded-xl font-medium transition-all duration-300 transform hover:-translate-y-0.5 text-xs sm:text-sm md:text-base bg-transparent border border-blue-500/50 text-blue-300/90 hover:bg-blue-500/10 hover:text-white/90"
};
...
export const homeCarsStyles = {
  ...
  title: "text-4xl py-2 font-[pacifico] md:text-5xl font-bold bg-clip-text text-transparent bg-blue-400 mb-4",
  ...
  priceText: "bg-blue-400 bg-clip-text text-transparent",
  ...
  carTypeBadge: "bg-gray-800 text-blue-400 px-2.5 py-1 rounded-full mr-2 text-xs font-medium",
  ...
  specIcon: (isHovered) => `w-4 h-4 ${isHovered ? 'text-blue-400' : 'text-gray-500'}`,
...
export const carDetailStyles = {
  ...
  backButtonIcon: "text-blue-400 text-lg",
  ...
  carouselIndicator: (active) => `w-3 h-3 rounded-full ${active ? 'bg-blue-500' : 'bg-gray-500'}`,
  carName: "text-2xl sm:text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-500",
  ...
  specCard: "flex flex-col items-center bg-gray-800/60 backdrop-blur-sm p-3 sm:p-4 rounded-xl border border-gray-700 hover:border-blue-500 transition-all",
  ...
  inputContainer: (active) => `relative rounded-lg border transition-all ${active ? 'border-blue-500' : 'border-gray-600'}`,
  inputIcon: "absolute left-3 top-2.5 text-blue-400",
  ...
  submitButton: "w-full flex items-center justify-center py-2.5 rounded-lg bg-gradient-to-r from-blue-400 to-blue-500 cursor-pointer text-white font-bold hover:from-blue-400 hover:to-blue-500 transition-all group"
};
...
export const testimonialStyles = {
  ...
  badgeText: "text-sm font-medium text-blue-400",
  title: "text-4xl sm:text-5xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-600 mb-4 font-[pacifico]",
  accentText: "text-blue-400",
  dividerContainer: "flex justify-center items-center mb-5",
  dividerLine: "h-0.5 w-16 sm:w-20 bg-blue-600 rounded-full",
  subtitle: "text-lg text-gray-400 max-w-3xl mx-auto",
  grid: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8",
  card: "relative rounded-2xl overflow-hidden transform transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl border-t-4 border-blue-400",
  ...
  carIcon: "text-blue-400 mr-3",
  carText: "font-semibold text-blue-400 text-base",
  authorContainer: "flex items-center",
  avatar: "bg-gradient-to-br from-blue-500 to-blue-700 w-14 h-14 rounded-full flex items-center justify-center text-white font-bold text-xl",
  authorInfo: "ml-4",
  authorName: "font-bold text-white text-lg",
  authorRole: "text-blue-400 text-sm",
  decorativeCorner: "absolute top-0 right-0 w-16 h-16 bg-gradient-to-br from-blue-700 to-blue-800 transform translate-x-6 -translate-y-6 rotate-45 opacity-30",
  ...
  ctaButton: "bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white font-bold py-3 font-[pacifico] px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg shadow-blue-500/20",
...
export const footerStyles = {
  ...
  roadLine: "absolute top-12 w-full h-0.5 bg-gradient-to-r from-transparent via-blue-600 to-transparent",
  ...
  socialIcon: "w-8 h-8 sm:w-10 sm:h-10 bg-gray-800 hover:bg-blue-400 transition-colors rounded-full flex items-center justify-center text-sm sm:text-base",
  ...
  subscribeButton: "w-full flex items-center justify-center py-2 sm:py-3 bg-blue-400 hover:from-cyan-600 hover:to-blue-700 cursor-pointer text-white font-medium rounded-lg transition-transform duration-300 transform hover:-translate-y-1 text-sm sm:text-base",
...
export const contactPageStyles = {
  ...
  title: "text-3xl font-['Pacifico'] sm:text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-500 mb-2 flex items-center justify-center",
  divider: "w-16 sm:w-20 md:w-24 h-0.5 bg-gradient-to-r from-blue-500 to-blue-400 mx-auto mb-3",
  ...
  infoCardCircle1: "absolute -top-4 -right-4 w-16 h-16 bg-blue-500/10 rounded-full",
  infoCardCircle2: "absolute -bottom-4 -left-4 w-14 h-14 bg-blue-400/10 rounded-full",
  infoTitle: "text-xl sm:text-xl font-semibold text-white flex items-center",
  infoIcon: "mr-3 text-blue-400 text-lg",
  ...
  offerContainer: "mt-4 bg-gradient-to-r from-blue-900/30 to-blue-800/30 p-3 rounded-lg border border-blue-500/20",
  offerIcon: "text-blue-400 mr-2",
  ...
  formCircle1: "absolute top-0 right-0 w-16 h-16 bg-blue-500/10 rounded-bl-full",
  formCircle2: "absolute bottom-0 left-0 w-14 h-14 bg-blue-500/10 rounded-tr-full",
  ...
  inputIcon: "absolute inset-y-0 left-0 pl-3 flex items-center text-blue-400",
  ...
  } focus:outline-none focus:ring-1 focus:ring-blue-500 text-sm transition-all`,
  select: (isActive) => `w-full pl-10 pr-3 py-2 bg-gray-700/50 cursor-pointer text-white rounded-lg border ${
    isActive ? 'border-blue-500' : 'border-gray-600'
  } focus:outline-none focus:ring-1 focus:ring-blue-500 text-sm appearance-none transition-all`,
  textareaIcon: "absolute top-2.5 left-3 text-blue-400",
  textarea: (isActive) => `w-full pl-10 pr-3 py-2 bg-gray-700/50 text-white rounded-lg border ${
    isActive ? 'border-blue-500' : 'border-gray-600'
  } focus:outline-none focus:ring-1 focus:ring-blue-500 text-sm transition-all`,
  submitButton: "w-full cursor-pointer flex items-center justify-center py-2.5 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 rounded-lg text-white font-medium text-sm shadow-md transition-all transform hover:-translate-y-0.5 group mt-2",
...
export const carPageStyles = {
  ...
  title: "relative text-3xl sm:text-4xl md:text-5xl font-bold mb-2 z-10 font-['Pacifico'] bg-blue-400 bg-clip-text text-transparent",
  ...
  priceBadge: "absolute bottom-3 left-3 bg-blue-400 text-white px-3 py-1.5 rounded-full text-xs sm:text-sm font-medium shadow-lg",
...
export const myBookingsStyles = {
  ...
  // Title
  title: "text-3xl sm:text-4xl pb-3 md:text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-500",
  ...
  // Loading spinner
  loadingSpinner: "animate-spin rounded-full h-16 w-16 border-t-2 border-b-2 border-blue-500",

  // Error state
  errorContainer: "text-center py-8 bg-gray-800/50 rounded-2xl border border-gray-700",
  errorText: "text-red-400",
  retryButton: "mt-4 px-4 py-2 bg-blue-600 rounded-lg text-white",
  ...
  emptyIcon: "text-4xl text-blue-500",
  emptyTitle: "text-2xl font-semibold mb-2",
  emptyText: "text-gray-400 max-w-md mx-auto",
  browseButton: "inline-block mt-6 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg flex items-center justify-center gap-2",
  ...
  priceText: "text-blue-400 font-bold text-xl",
  ...
  detailIcon: "w-10 h-10 rounded-lg bg-gray-800 flex items-center justify-center text-blue-400",
  ...
  bookAgainButton: "flex-1 py-2 px-4 bg-blue-600 hover:bg-blue-700 rounded-lg flex items-center justify-center gap-2",
  ...
  priceValue: "font-medium text-blue-400",
  ...
  modalBookButton: "flex-1 py-3 px-4 bg-blue-600 hover:bg-blue-700 rounded-lg flex items-center justify-center gap-2",
};