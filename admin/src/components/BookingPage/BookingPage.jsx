...
const StatusIndicator = ({ status, isEditing, newStatus, onStatusChange }) => {
  return isEditing ? (
    <select
      ...
      className="bg-gray-800/50 text-sm px-2 py-1 rounded focus:outline-none focus:ring-1 focus:ring-blue-500"
    >
...
const BookingCardActions = ({
  ...
  <div className={BookingPageStyles.bookingActions}>
    <div className="items-center text-blue-400 hidden md:flex">
      <FaChevronDown
        className={`transition-transform duration-300 ${
          isExpanded ? "rotate-180" : ""
        }`}
