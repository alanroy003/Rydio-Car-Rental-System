...
const StatCard = ({ title, value, icon: Icon, className = "" }) => (
  <div
    className={`${styles.gradientblue} ${styles.rounded2xl} ${styles.statCard} ${styles.borderGray} ${styles.borderHoverblue} ${className}`}
  >
    <div className="flex items-start justify-between">
      ...
      <div className="p-3 rounded-lg bg-gray-800/30">
        <Icon className={`${styles.textblue} text-xl`} />
      </div>
    </div>
  </div>
);
...
const CarCard = ({ car, onEdit, onDelete }) => {
  ...
  return (
    <div
      className={`${styles.gradientGray} ${styles.rounded2xl} ${styles.carCard} ${styles.borderGray} ${styles.borderHoverblue}`}
    >
      ...
      <div className="p-5">
        ...
        <div className="flex justify-between border-t border-gray-800 pt-4">
          <button
            onClick={() => onEdit(car)}
            className={`flex items-center ${styles.textblue} hover:text-blue-300 transition-colors`}
          >
...
const EditModal = ({ car, onClose, onSubmit, onChange }) => {
  ...
  return (
    <div className={styles.modalOverlay}>
      <div
        className={`${styles.gradientGrayToGray} ${styles.rounded2xl} ${styles.modalContainer} ${styles.borderblue}`}
      >
        <div className="p-6">
          <div className="flex justify-between items-center border-b border-blue-800/30 pb-4">
            ...
            {car.image && (
              <div className="flex justify-center">
                <img
                  ...
                  alt="preview"
                  className="h-40 object-contain rounded-md border border-blue-800/30"
                />
              </div>
            )}
...
const NoCarsView = ({ onResetFilter }) => (
  <div className={`${styles.gradientGray} ${styles.noCarsContainer}`}>
    <div className="mx-auto w-24 h-24 rounded-full bg-gradient-to-br from-blue-900/30 to-amber-900/30 flex items-center justify-center mb-6">
      <div className="bg-gradient-to-br from-blue-700 to-amber-700 w-16 h-16 rounded-full flex items-center justify-center">
        <FaCar className="h-8 w-8 text-blue-300" />
      </div>
    </div>
...
const FilterSelect = ({ value, onChange, categories }) => (
  <div
    className={`${styles.gradientGray} ${styles.rounded2xl} ${styles.filterSelect} ${styles.borderGray} ${styles.borderHoverblue}`}
  >
    ...
    <div className="relative">
      <select
        ...
        className={`${styles.inputField} focus:outline-none focus:ring-2 focus:ring-blue-500`}
      >
        {categories.map((c) => (
      ...
      <div className="absolute left-1 top-4 text-blue-500">
        <FaFilter />
      </div>
    </div>
  </div>
    ...
    <div className="min-h-screen bg-gray-950 p-4 sm:p-6">
      <div className="relative mb-8 pt-16 text-center">
        <div className="absolute inset-x-0 top-0 flex justify-center">
          <div className="h-1 w-20 bg-gradient-to-r from-blue-500 to-amber-500 rounded-full" />
        </div>
