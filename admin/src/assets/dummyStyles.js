...
export const styles = {
  ...
  gradientblue: "bg-gradient-to-br from-blue-900/30 to-amber-900/30",
  ...
  buttonPrimary: "px-5 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-amber-600 text-white",
...
export const bookStyles = {
  ...
  gradientblueToAmber: "bg-gradient-to-br from-blue-800/50 to-amber-800/50",
  gradientblueToAmberSolid: "bg-gradient-to-br from-blue-700 to-amber-700",
  ...
  buttonEdit: "bg-gradient-to-r from-blue-700/50 to-amber-700/50 text-blue-300 hover:text-white text-sm px-3 py-1 rounded-lg",

  // Common input styles
  inputField: "bg-gray-800/50 border border-gray-700 w-full px-4 py-2.5 text-gray-200 rounded-lg",
  inputFieldWithIcon: "bg-gray-800/50 border border-gray-700 w-full px-4 py-2.5 pl-10 text-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500",
  ...
  specItem: "flex flex-col items-center p-3 rounded-xl border border-gray-800 hover:border-blue-500/50 transition-all",
  detailItem: "flex items-start",
  bookingCard: "backdrop-blur-sm rounded-2xl overflow-hidden border border-gray-800 hover:border-blue-500/50 transition-all duration-300",
...
export const AddCarPageStyles = {
  ...
  gradientBlob1: "absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-gradient-to-r from-blue-600 to-blue-800 blur-3xl opacity-10",
  ...
  gradientBlob3: "absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-48 rotate-45 bg-gradient-to-r from-blue-500 to-amber-500 blur-xl opacity-10",

  // Header
  headerContainer: "relative mb-8 pt-20 text-center",
  headerDivider: "absolute inset-x-0 top-0 flex justify-center",
  headerDividerLine: "h-1 w-20 bg-gradient-to-r from-blue-500 to-amber-500 rounded-full",
  title: "text-4xl font-extrabold py-4 text-white sm:text-5xl mb-3 tracking-wide",
  titleGradient: "text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-amber-400",
  ...
  input: "glass-input w-full px-4 py-3 rounded-xl text-gray-200 shadow-sm focus:ring-2 focus:ring-blue-500 transition-all",
  inputWithPrefix: "glass-input w-full pl-8 pr-4 py-3 rounded-xl text-gray-200 shadow-sm focus:ring-2 focus:ring-blue-500 transition-all",
  select: "bg-gray-800/50 border border-gray-700 w-full px-4 py-3 rounded-xl text-gray-200 focus:ring-2 focus:ring-blue-500",
  textarea: "glass-input w-full px-4 py-3 rounded-xl text-gray-200 shadow-sm focus:ring-2 focus:ring-blue-500 transition-all",
  ...
  radioLabel: (isSelected) =>
    `flex-1 flex items-center justify-center p-3 rounded-xl cursor-pointer transition-all hover:shadow-md ${
      isSelected
        ? "bg-gradient-to-r from-blue-700/30 to-amber-700/30 border border-blue-500/50"
        : "glass-input"
    }`,
  radioInput: "h-4 w-4 text-blue-500 focus:ring-blue-500",
  ...
  // Button
  submitButton: "px-10 py-4 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 text-lg bg-gradient-to-r from-blue-600 to-amber-600 hover:from-blue-500 hover:to-amber-500",
  buttonText: "drop-shadow-md",

  // Icons
  iconSmall: "w-5 h-5 mr-2 text-blue-500",
  iconMedium: "w-6 h-6 mr-2 text-red-400",
  iconLarge: "w-8 h-8 mr-3 text-blue-400",
...
export const toastStyles = {
  success: {
    container: "bg-gradient-to-r from-gray-800 to-gray-900 border-l-4 border-blue-500",
...
export const BookingPageStyles = {
  ...
  filterInput: "bg-gray-800/50 border border-gray-700 w-full px-4 py-2.5 pl-10 text-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500",
  filterIconContainer: "absolute left-3 top-3 text-blue-500",
  totalBookingsContainer: "bg-gradient-to-br from-blue-900/30 to-amber-900/30 rounded-lg p-4 border border-blue-800/30 flex items-center justify-center",
  totalBookingsLabel: "text-gray-400 text-sm mb-1",
  totalBookingsValue: "text-2xl font-bold text-blue-400",

  // Booking Card
  bookingCard: "bg-gradient-to-br from-gray-900/50 to-gray-900/30 backdrop-blur-sm rounded-2xl overflow-hidden border border-gray-800 hover:border-blue-500/50 transition-all duration-300",
  bookingCardHeader: "flex items-center mb-4 md:mb-0",
  bookingIconContainer: "bg-gradient-to-br from-blue-800/50 to-amber-800/50 p-3 rounded-xl mr-4",
  bookingIcon: "text-blue-400 text-xl",
  bookingCustomer: "text-lg font-bold text-white",
  bookingEmail: "text-sm text-gray-400",
  bookingExpandIcon: "flex items-center text-blue-400 ml-auto md:hidden",
  ...
  bookingAmount: "text-sm font-semibold text-blue-400",
  ...
  bookingEditButton: "bg-gradient-to-r from-blue-700/50 to-amber-700/50 text-blue-300 hover:text-white text-sm px-3 py-1 rounded-lg flex items-center",
  ...
  panelIcon: "mr-2 text-blue-400",

  // Detail
  detailContainer: "flex items-start",
  detailIcon: "text-blue-400 mt-1 mr-3",
  detailLabel: "text-xs text-gray-400",
  detailValue: "text-sm font-medium text-white",

  // Spec
  specContainer: "flex flex-col items-center bg-gradient-to-br from-gray-900/30 to-gray-900/10 p-3 rounded-xl border border-gray-800 hover:border-blue-500/50 transition-all",
  specIcon: "text-xl mb-2 text-blue-400",
  ...
  noBookingsIconContainer: "mx-auto w-24 h-24 rounded-full bg-gradient-to-br from-blue-900/30 to-amber-900/30 flex items-center justify-center mb-6",
  noBookingsIcon: "bg-gradient-to-br from-blue-700 to-amber-700 w-16 h-16 rounded-full flex items-center justify-center",
  noBookingsIconSvg: "h-8 w-8 text-blue-300",
  noBookingsTitle: "mt-4 text-xl font-medium text-white",
  noBookingsText: "mt-2 text-gray-400",
  noBookingsButton: "mt-4 px-5 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-amber-600 text-white flex items-center mx-auto",

  // Car Image
  carImageContainer: "bg-gradient-to-br from-blue-900/30 to-amber-900/30 rounded-xl w-20 h-12 flex items-center justify-center",
};

export const statusConfig = {
  completed: { bg: "bg-green-900/20", text: "text-green-400" },
  pending: { bg: "bg-amber-900/20", text: "text-amber-400" },
  active: { bg: "bg-blue-900/20", text: "text-blue-400" },
